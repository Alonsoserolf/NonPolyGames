...
public class tictac_cpu_mode : MonoBehaviour
{
    ...
    public Text player_turn_text = null;
    public Text player_won_text = null;
    private int player_turn_text_overrule = 0;
    public static tictac_cpu_mode instance;
    ...
    private void checkWin()
    {
        ...
        if (level3[0] == 1 && level3[1] == 1 && level3[2] == 1 || level3[3] == 1 && level3[4] == 1 && level3[5] == 1 || level3[6] == 1 && level3[7] == 1 && level3[8] == 1 || level3[1] == 1 && level3[4] == 1 && level3[7] == 1 || level3[0] == 1 && level3[3] == 1 && level3[6] == 1 || level3[2] == 1 && level3[5] == 1 && level3[8] == 1 || level3[0] == 1 && level3[4] == 1 && level3[8] == 1 || level3[2] == 1 && level3[4] == 1 && level3[6] == 1)
        {
            ...
            player_turn_text.text = "Player 1 won,click";
        ...
        {
            player_turn_text.text = "Player 1 won";
            player_turn_text.color = Color.blue;
            player_turn_text_overrule = 1;
        ...
        {
            player_turn_text.text = "Player 2 won";
        ...
        if (level3[1] == 2 && level2[4] == 2 && level1[7] == 2 || level3[3] == 2 && level2[4] == 2 && level1[5] == 2 || level3[8] == 2 && level2[7] == 2 && level1[6] == 2 || level3[5] == 2 && level2[4] == 2 && level1[3] == 2 || level3[7] == 2 && level2[4] == 2 && level1[1] == 2 || level3[8] == 2 && level2[4] == 2 && level1[0] == 2 || level3[8] == 2 && level2[5] == 2 && level1[2] == 2 || level3[8] == 2 && level2[4] == 2 && level1[0] == 2 || level3[6] == 2 && level2[4] == 2 && level1[2] == 2 || level3[6] == 2 && level2[7] == 2 && level1[8] == 2 || level3[6] == 2 && level2[3] == 2 && level1[0] == 2 || level3[0] == 2 && level2[1] == 2 && level1[2] == 2 || level3[0] == 2 && level2[3] == 2 && level1[6] == 2 || level3[0] == 2 && level2[4] == 2 && level1[5] == 2 || level3[2] == 2 && level2[5] == 2 && level1[8] == 2 || level3[2] == 2 && level2[4] == 2 && level1[6] == 2 || level3[2] == 2 && level2[1] == 2 && level1[0] == 2)
        {
    ...
    public void mode_choice_func()
    {
        mode_choice = 0;
    }
    public void destroy_script()
    {
        Destroy(this);
    }
